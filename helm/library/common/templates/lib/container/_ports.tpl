...
- name: {{ $portName }}
  ...
  {{- include "common.lib.container.ports.detectSortingIssues" (dict "portsByName" $portsByName "rootCtx" $rootCtx) -}}
...
{{- define "common.lib.container.ports.detectSortingIssues" -}}
  {{- $rootCtx := .rootCtx -}}
