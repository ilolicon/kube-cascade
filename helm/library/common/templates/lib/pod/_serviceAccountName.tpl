...
{{/* Call this template:
{{ include "common.lib.pod.serviceAccountName" (dict "rootCtx" $ "objectData" $objectData) }}
rootCtx: The root context of the chart.
objectData: The object data to be used to render the Pod.
*/}}
{{- define "common.lib.pod.serviceAccountName" -}}
  {{- $rootCtx := .rootCtx -}}
  ...
  {{- range $name, $serviceAccount := $rootCtx.Values.serviceAccount -}}
    {{- $tempName := include "common.lib.chart.names.fullname" $rootCtx -}}
