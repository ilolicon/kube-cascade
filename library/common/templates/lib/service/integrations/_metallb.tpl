{{- define "common.lib.service.integration.metallb" -}}
  ...
  {{- if $metallb.enabled -}}
    {{- include "common.lib.service.integration.validate" (dict "objectData" $objectData "integration" $metallb) -}}

    {{ $sharedKey := (include "common.lib.metadata.namespace" (dict "rootCtx" $rootCtx "objectData" $objectData "caller" "Service")) }}
