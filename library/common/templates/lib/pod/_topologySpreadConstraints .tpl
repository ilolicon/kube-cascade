...
{{/* Call this template:
{{ include "common.lib.pod.topologySpreadConstraints" (dict "rootCtx" $ "objectData" $objectData) }}
rootCtx: The root context of the chart.
objectData: The object data to be used to render the Pod.
*/}}
{{- define "common.lib.pod.topologySpreadConstraints" -}}
  {{- $rootCtx := .rootCtx -}}
...
- maxSkew: 1
  ...
  labelSelector:
    matchLabels:
      {{- include "common.lib.metadata.selectorLabels" (dict "rootCtx" $rootCtx "objectType" "pod" "objectName" $objectData.shortName) | indent 6 }}
